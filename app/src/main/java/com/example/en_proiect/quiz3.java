...
public class quiz3 extends AppCompatActivity {
    ...
    private void calculateScore() {
        ...
        checkAnswer(R.id.answers1, R.id.answer1_b, "1");
        checkAnswer(R.id.answers2, R.id.answer2_a, "2");
        checkAnswer(R.id.answers3, R.id.answer3_b, "3");
        checkAnswer(R.id.answers4, R.id.answer4_c, "4");
        checkAnswer(R.id.answers5, R.id.answer5_c, "5");
        checkAnswer(R.id.answers6, R.id.answer6_a, "6");
    }
